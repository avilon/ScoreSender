...
{
    /// <summary>
    /// Шифровка/дешифровка строки по алгоритму SHA1
    /// </summary>
    public static class StringCryptor
    {
        //метод шифрования строки
        public static string CryptString(string ishText, string pass,
        ...
        public static string DecryptString(string ciphText, string pass,
               string sol = "doberman", string cryptographicAlgorithm = "SHA1",
               int passIter = 2, string initVec = "a8doSuDitOz1hZe#",
               int keySize = 256)
        {
